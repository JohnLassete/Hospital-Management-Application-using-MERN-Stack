...
const Appointments = () => {
    ...
    const handleDeleteAppointment = (id) => {
        axios.delete(`http://localhost:5000/appointments/delete/${id}`)
            .then(response => { console.log(response.data); setAppointments(appointments.filter(appointment => appointment._id !== id)); })
            ...
            <div className='flex-column'>
                <div className='add-form'>
                    ...
                    <form className="appointment-form" onSubmit={isEditMode ? (e) => handleUpdateAppointment(selectedAppointment._id, e) : handleAddAppointment}>
                        ...
                        <input type="text" value={isEditMode ? selectedAppointment.patientName : newAppointment.patientName}
